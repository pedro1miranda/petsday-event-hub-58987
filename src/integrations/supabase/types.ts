  ...
  public: {
    Tables: {
      ...
      lucky_numbers_novo: {
        ...
        Relationships: [
          {
            foreignKeyName: "lucky_numbers_novo_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "lucky_numbers_novo_pet_id_fkey"
            columns: ["pet_id"]
            isOneToOne: false
            referencedRelation: "pets_novo"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      pets_novo: {
        ...
        Relationships: [
          {
            foreignKeyName: "pets_novo_tutor_id_fkey"
            columns: ["tutor_id"]
            isOneToOne: false
